...
IntroTagColor = 'c46900'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaSprite('JukeBoxTag', 'empty', -305-IntroTagWidth, 500)
	...
	--the box
	makeLuaSprite('JukeBox', 'empty', -305-IntroTagWidth, 500)
	makeGraphic('JukeBox', 300, 130, '000000')
	setObjectCamera('JukeBox', 'other')
	addLuaSprite('JukeBox', true)
	
	--the text for the "Now Playing" bit
	makeLuaText('JukeBoxText', songName, 300, -305-IntroTagWidth, 515)
	...
	makeLuaText('JukeBoxSubText', 'Nicolonda', 300, -305-IntroTagWidth, 560)
...
function onStartCountdown()
	setPropertyFromClass('GameOverSubstate', 'characterName', 'good-gay');
	setPropertyFromClass('GameOverSubstate', 'deathSoundName', 'fnf_loss_sfx-chuck');
	setPropertyFromClass('GameOverSubstate', 'loopSoundName', 'gameOver-chuck');
	setPropertyFromClass('GameOverSubstate', 'endSoundName', 'gameOverEnd-chuck');
end
